    ...
    public static class InputDirectionExtensions
    {
        ...
        public static Vector2Int ToVector2Int(this InputDirection direction)
        {
            return direction switch
            {
                ...
                _ => throw new System.ArgumentOutOfRangeException(nameof(direction), direction, "Invalid InputDirection value.")
            };
        }
        ...
        public static FacingDirection ToFacingDirection(this InputDirection input)
        {
            return input switch
            {
                ...
                _ => throw new System.ArgumentOutOfRangeException(nameof(input), input, "Invalid InputDirection value.")
            };
        }
    }
}
